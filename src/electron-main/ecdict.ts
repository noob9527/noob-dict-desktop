import {
  EcDict,
  EcDictSearchSuccessResult,
  EcDictSuggest,
} from '@noob9527/noob-dict-ecdict'
import { SearchEmptyResult, SearchOption } from '@noob9527/noob-dict-core'
import logger from '../electron-shared/logger'

let ecDict: EcDict | null = null

export function handleEcDictFileLocationChange(
...
export const ecDictSearchService = {
  async fetchResult(
    text: string,
    option?: SearchOption,
  ): Promise<EcDictSearchSuccessResult | SearchEmptyResult> {
